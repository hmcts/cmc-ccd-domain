...
case ${ENV} in
  local)
    ...
    AUTH_PROVIDER_BASE_URL=http://host.docker.internal:4502
...
docker run \
  ...
  -e "USER_ROLES=citizen, caseworker-cmc, caseworker-cmc-solicitor, caseworker-cmc-systemupdate, caseworker-cmc-rparobot, letter-holder, caseworker-autotest1, caseworker-cmc-anonymouscitizen, caseworker-cmc-judge, caseworker-cmc-legaladvisor, caseworker-cmc-pcqextractor, payments, TTL-admin" \
