...
docker run \
  ...
  -e "USER_ROLES=citizen, caseworker-cmc, caseworker-cmc-solicitor, caseworker-cmc-systemupdate, letter-holder, caseworker-autotest1, caseworker-cmc-anonymouscitizen, caseworker-cmc-judge, caseworker-cmc-legaladvisor, caseworker-cmc-pcqextractor, payments" \
