...
EXPOSE 4000
USER root
RUN chmod 777 /data/cmc-ccd.xlsx
CMD cd /opt/ccd-definition-processor && yarn json2xlsx -D /data/sheets -o /data/cmc-ccd.xlsx && "/wait" && "/scripts/upload-definition.sh" && [ "empty.jar" ]
